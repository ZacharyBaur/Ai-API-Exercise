...
document.addEventListener('DOMContentLoaded', () => {
  ...
  btnRandom.addEventListener('click', async () => {
    ...
    try {
      ...
      console.error(e);
      randomContent.textContent = 'Failed to fetch joke. Check console.';
    } finally {
  ...
  btnMultiple.addEventListener('click', async () => {
    ...
    try {
      ...
      console.error(e);
      jokesList.innerHTML = '<li class="text-red-600">Failed to fetch jokes. Check console.</li>';
    } finally {
  ...
  // Optionally fetch an initial random joke
  // btnRandom.click();
});
